...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Salesforce-Platform_App_Builder-00A1E0?style=flat&logo=salesforce" />
...
- Enterprise integrations via **REST/SOAP APIs, Named Credentials, External Services, and Platform Events**
- CI/CD with **SFDX, Git, Jenkins, GitHub Actions, and Change Sets**
- Security architecture — profiles, roles, permission sets, OWD, sharing rules, CRUD/FLS
- Applied AI — **Agentforce, RAG, prompt engineering, and AI-assisted development**
...
> Real-time, event-driven contact-center routing across Amazon Connect and Salesforce

- Replaced manual call triage with real-time, event-driven case routing — improving agent response times and customer experience
- **Architecture:** Amazon Connect → Salesforce Platform Events → Apex handlers → LWC Agent Desktop
- Deployed with **GitHub Actions CI/CD** enforcing **90%+ test coverage** and sandbox-to-production rollback planning

**Tech:** `Amazon Connect` `Platform Events` `Apex` `LWC` `CI/CD`
...
Integration      REST · SOAP · Bulk API · OAuth 2.0 · Named Credentials · External Services · JSON
...
Python & AI      Python · LangChain · ChromaDB · RAG · Prompt Engineering
                 Pandas · Scikit-learn · XGBoost · Streamlit · SQL

Methodology      Agile/Scrum · SDLC · Unit Testing · UAT · Documentation
```
...
| 5 | Salesforce DevOps Fundamentals Certificate |
